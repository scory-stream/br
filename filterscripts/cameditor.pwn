...
{
	if(IsCreating[playerid] == false) SendClientMessage(playerid, -1, "Введите /edcam для входа в режим редактора камеры.");
}
...
stock FlyMode(playerid)
{
	...
	SendClientMessage(playerid, -1, "Используйте /ofedcam для выхода из режима.");
